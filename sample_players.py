...
if __name__ == "__main__":
    ...
    player1 = CustomPlayer(score_fn=custom_score, search_depth=2, method='minimax', iterative=True)
    ...
    action = player1.get_move(game, game.get_legal_moves(), timeit.default_timer())
    #print 'ACTION', action
